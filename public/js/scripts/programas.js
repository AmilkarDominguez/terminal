...
var title_modal_data = "programas";
...
function show_data(obj) {
    ...
    $("#link").val(obj.link);
    $("#auspice_id").val(obj.auspice_id);   
    $("#presenter_id").val(obj.presenter_id);   
...
function SelectAuspico() {
    $.ajax({
        url: "/api/list_auspice",
        method: 'get',
        success: function (result) {
            var code = '<div class="form-group">';
            code += '<label><b>Auspicadores:</b></label>';
            code += '<select class="form-control" name="auspice_id" id="auspice_id" required>';
...
function SelectPresenter() {
    $.ajax({
        url: "/api/list_presenter",
        method: 'get',
        success: function (result) {
            var code = '<div class="form-group">';
            code += '<label><b>Presentadores:</b></label>';
            code += '<select class="form-control" name="presenter_id" id="presenter_id" required>';
            code += '<option disabled value="" selected>(Seleccionar)</option>';
            $.each(result, function (key, value) {
                code += '<option value="' + value.id + '">' + value.nombre + '</option>';
            });
