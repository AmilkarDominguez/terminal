    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <h2 class="card-title text-primary">Auspicios</h2>
                    </div>
            ...
            <form class="form-data" id="form-data" novalidate>
                <div class="modal-body">
                        <div class="modal-body">
                            ...
                            <div class="md-form mb-3">
                                <label><b>Teléfono de contácto:</b></label>
                                <input type="text" class="form-control"  id="telefono_contacto" name="telefono_contacto" placeholder="Teléfono de contácto"
                                    required>
                                <div class="invalid-feedback">
                                    Dato necesario.
                                </div>
...
<script src="{{ URL::asset('js/scripts/auspicios.js') }}"></script>
@endsection