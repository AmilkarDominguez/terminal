        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2 class="card-title text-primary">Usuarios</h2>
                        </div>
...
@section('scripts')
    ...
    <script src="{{ URL::asset('js/scripts/usuario.js') }}"></script>
@endsection
